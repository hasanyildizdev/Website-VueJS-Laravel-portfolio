...
<template>
  <footer id="footer" class="bg-black text-white py-4 max-w-screen-2xl ">
    <div class="container mx-auto">

      <div class="lg:px-2 flex flex-col lg:flex-row items-center justify-between">

        <div class="flex flex-col items-center justify-center">
          <p class="pt-2 text-2xl font-extrabold text-white">HASAN YILDIZ</p>
          <a href="https://www.iyiapp.com" class="text-xl font-bold text-white">www.iyiapp.com</a>
        </div>

        <div class="my-16 lg:mt-4 lg:my-0 flex flex-col items-center justify-center">
          <div class="flex flex-col items-center justify-center text-black">
            <div class="pt-2 lg:pt-0 flex items-center">
              <h4 class="w-72  text-white text-center font-bold lg:text-lg border-2 border-white p-1">
                hasanyildiz.97@hotmail.com </h4>
            </div>
            <div class="my-2 flex items-center">
              <h4 class="w-72 text-white text-center font-bold text-xl border-2 border-white p-1"> +90 546 933 2197
              </h4>
            </div>
            <div class="lg:pt-0 flex items-center  text-white">
              <h4 class="w-72 text-center font-bold text-xl border-2 border-white p-1">Istanbul / TURKEY</h4>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-center">
          <div class="flex flex-row">
            ...
            <div class="pr-2">
              <a href="https://www.youtube.com/@hasan.yildiz" target="_blank">
                <svg fill="#FFFFFF" width="50px" height="50px" viewBox="0 -5 34 34" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div class="flex items-center justify-center">
              <a href="whatsapp://send?text=Hello Hasan!&phone=+905469332197">
                <svg width="53px" height="53px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <rect x="0" fill="#000000" width="20" height="20" />
                  <path fill="#FFFFFF"
          ...
          <div>
            <p class="pt-4  opacity-80 text-sm">
              &copy; 2022 iyiapp.com All right reserved.
            </p>
          </div>
        </div>
